...
print('OVERSAMPLING5 0', len(labels_0_indexes))
print('OVERSAMPLING5 1', len(labels_1_indexes))
...
dor.save_object(k_fold_set_1_small, 'k_fold_set_1_r5_small.pkl')
dor.save_object(test_set_1_small, 'test_set_1_r5_small.pkl')

dor.save_object(k_fold_set_2_small, 'k_fold_set_2_r5_small.pkl')
dor.save_object(test_set_2_small, 'test_set_2_r5_small.pkl')
#rf = pas.RandomForest()

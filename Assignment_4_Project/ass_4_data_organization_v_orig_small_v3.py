...
ON_feature_set1_df = feature_set1_df.copy()
ON_feature_set2_df = feature_set2_df.copy()
...
print('ORIGINAL 0', len(labels_0_indexes))
print('ORIGINAL 1', len(labels_1_indexes))
...
dor.save_object(k_fold_set_1_small, 'k_fold_small.pkl')
dor.save_object(test_set_1_small, 'test_small.pkl')

dor.save_object(k_fold_set_2_small, 'k_fold_set_2_small.pkl')
dor.save_object(test_set_2_small, 'test_set_2_small.pkl')

...
print('OVERSAMPLING7 0', len(labels_0_indexes))
print('OVERSAMPLING7 1', len(labels_1_indexes))
...
save_object(k_fold_set_1_small, 'k_fold_set_1_r7_small.pkl')
save_object(test_set_1_small, 'test_set_1_r7_small.pkl')

save_object(k_fold_set_2_small, 'k_fold_set_2_r7_small.pkl')
save_object(test_set_2_small, 'test_set_2_r7_small.pkl')
